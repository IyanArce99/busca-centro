...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  // Blog (/blog and /blog/*) is temporarily excluded until the guides have
  // enough real content to merit indexing.
  ...
  return [...staticEntries, ...seoPageEntries, ...centerEntries];
}
