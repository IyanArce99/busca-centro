  ...
  if (isSubmitted) {
    return (
      <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-6 text-sm text-emerald-800">
        ...
        <p className="mt-1">
          Gracias por tu interés. Vamos a revisar los datos enviados antes de publicar la ficha del centro en el directorio.
        </p>
      </div>
    );
  }
  ...
  return (
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="text-sm">
          <span className="mb-1 block font-medium text-slate-700">Ciudad {REQUIRED}</span>
          <input required type="text" className={FIELD_CLASS} />
        </label>
        <label className="text-sm sm:col-span-2">
          <span className="mb-1 block font-medium text-slate-700">Dirección {REQUIRED}</span>
          <input required type="text" className={FIELD_CLASS} />
        </label>
        <label className="text-sm">
          <span className="mb-1 block font-medium text-slate-700">Persona de contacto {REQUIRED}</span>
          <input required type="text" className={FIELD_CLASS} />
        </label>
        <label className="text-sm">
          <span className="mb-1 block font-medium text-slate-700">Email {REQUIRED}</span>
        ...
        <label className="text-sm">
          <span className="mb-1 block font-medium text-slate-700">Web</span>
        ...
        <label className="text-sm">
          <span className="mb-1 block font-medium text-slate-700">Edades atendidas</span>
          <input type="text" placeholder="Ej. 4 meses a 3 años" className={FIELD_CLASS} />
        </label>
        <label className="text-sm sm:col-span-2">
          <span className="mb-1 block font-medium text-slate-700">Servicios principales</span>
